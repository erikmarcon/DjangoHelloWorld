...
#     phone = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Telefone Celular", "class":"form-control"}), label="")
...
#     property_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Nome da Propriedade", "class":"form-control"}), label="")
